...
// GenerateAwarenessMd builds the instruction file dropped for AI tools that expose no
// command-rewrite hook (Windsurf, Cline, Copilot, Gemini): it nudges the model to prefix
// commands with `tok` voluntarily.
func GenerateAwarenessMd(version string) string {
	lines := []string{
